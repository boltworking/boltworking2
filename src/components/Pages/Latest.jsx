...
export function Latest() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!user?.isAdmin && user?.role !== 'president_admin') {
      toast.error("Only President Admin or Super Admin can create posts");
      return;
    }
    ...
    try {
      const newsData = {
        ...
        category: newPost.type.toLowerCase(),
      };

      console.log('Creating news with data:', newsData);
      
      // Use news API endpoint for president admin
      ...
      console.log('Create news response:', responseData);
  ...
  const handleDeletePost = async (postId) => {
    if (!user?.isAdmin && user?.role !== 'president_admin') {
      toast.error("Only President Admin or Super Admin can delete posts");
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-6">
            {/* President Admin and Admin Create Post Section */}
            {(user?.isAdmin || user?.role === 'president_admin') && (
