        ...
        <div className="text-center">
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-2">
              {showRegister ? "Register" : selectedRole ? "Login" : "Select Your Role"}
            </h2>
          ...
          >
            {roles.map((role, index) => (
              <motion.button
                ...
                className={`p-6 rounded-xl bg-gradient-to-br ${role.color} text-white shadow-lg hover:shadow-xl transition-all duration-300`}
              >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    <option value="Education">software</option>
                  </select>
                </div>
            ...
            {selectedRole === "student" && (
              <button
                ...
                onClick={() => {
                  ...
                  if (showRegister) setSelectedRole(null);
                }}
