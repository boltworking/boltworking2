...
export function AdminDashboard() {
  ...
  // President Admin specific actions
  const presidentAdminActions = [
    {
      title: 'Create New Club',
      description: 'Create a new student club',
      icon: Building2,
      color: 'bg-blue-600',
    ...
    },
    {
      ...
      description: 'Set up a new student election',
      icon: Vote,
      color: 'bg-green-600',
  ...
  const actionsToShow = user?.role === 'president_admin' ? presidentAdminActions : quickActions;
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            {user?.role === 'president_admin' ? 'President Admin Dashboard' : 'Admin Dashboard'}
          </h1>
          <p className="text-gray-600 mt-1">Welcome back, {user?.name}</p>
          <div className="flex items-center mt-2">
            <Shield className="w-4 h-4 text-blue-600 mr-1" />
            <span className="text-sm text-blue-600 font-medium">
              {user?.role === 'president_admin' ? 'President Administrator' : 
        ...
        {/* President Admin Quick Actions */}
        {user?.role === 'president_admin' && (
          <div className="flex flex-col sm:flex-row gap-3 mt-4 sm:mt-0">
            <button 
              onClick={() => navigate('/clubs')}
              className="bg-blue-600 text-white px-6 py-3 rounded-lg flex items-center gap-2 hover:bg-blue-700 transition-colors font-semibold shadow-lg"
            >
            ...
            <button 
              ...
              className="bg-green-600 text-white px-6 py-3 rounded-lg flex items-center gap-2 hover:bg-green-700 transition-colors font-semibold shadow-lg"
            >
