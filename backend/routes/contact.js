  ...
  try {
    ...
    try {
      ...
      const mailOptions = {
        ...
        to: 'getabalewamtataw11@gmail.com',
        ...
        html: `
          ...
          <br>
          <p>Please log in to the admin panel to respond to this message.</p>
        `
      };
      
      await transporter.sendMail(mailOptions);
    } catch (emailError) {
      console.warn('Failed to send notification email to admin:', emailError.message);
    }
